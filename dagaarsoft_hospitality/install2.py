...
_CORE_CUSTOM_FIELDS = {
    ...
    # ── POS Awesome Hotel Integration ─────────────────────────────────────────
    "POS Profile": [
        {"fieldname": "posa_section_hotel_integration",
         "label": "Hotel Integration (DagaarSoft)",
         "fieldtype": "Section Break",
         "insert_after": "posa_section_cash_movement",
         "collapsible": 1},
        {"fieldname": "posa_enable_hotel_room",
         ...
         "description": "Show Hotel Room dropdown in POS Awesome. Selecting a room auto-fills the guest Customer, Guest Stay, and Guest Folio on the invoice."},
        ...
        {"fieldname": "posa_hotel_auto_customer",
         ...
         "description": "Automatically set the invoice customer to the room guest."},
    ],
}
